 ...
 * @author normal
 */
public class TestPacket_BitError {
    ...
    static {
        ...
        LOG = new LoggerFactory(myClass, TestPacket_BitError.CLASS_LOG_OUTPUT_MODE).getLOG();
        if (CLASS_LOG_OUTPUT_MODE == false) {
            LOG.info("チェックログ抑止中。");
        }
    }
    private final byte[] p_0;
    private final byte[] p_1;
    private final byte[] p_2;
    private final byte[] p_3;
    private final byte[] p_4;
    private final byte[] p_5;
    private final byte[] p_6;
    private final byte[] p_7;
    private final byte[] p_8;
    private final byte[] p_9;
    private final byte[] p_10;
    private final byte[] p_11;
    private final byte[] p_12;
    private final byte[] p_13;
    private final byte[] p_14;
    private final byte[] p_15;
    private final byte[] p_16;
    private final byte[] p_17;
    private final byte[] p_18;
    private final byte[] p_19;
    private final byte[] p_20;
    private final byte[] p_21;
    private final byte[] p_22;
    ...
    public List<byte[]> getList_NotContainError() throws DecoderException {
        List<byte[]> list_NotContainError = new ArrayList<>();
    ...
    public List<byte[]> getList_ContainError_WrongLength() {
        List<byte[]> list_ContainError_WrongLength = new ArrayList<>();
        ...
        return list_ContainError_WrongLength;
    }

    public List<TsPacket> getExpResult_Normal_And_Wrong_Sync() {
        List<TsPacket> expResult_Normal_And_Wrong_Sync = new ArrayList<>();
        ...
        return expResult_Normal_And_Wrong_Sync;
    }

    public List<TsPacket> getExpResult_Wrong_Length() {
        List<TsPacket> expResult_Wrong_Length = new ArrayList<>();
    ...
    public static File writeBytesToFile(List<byte[]> dataList) throws IOException {
    ...
    public static void dumpBytesList(Iterable<byte[]> target) {
        for (byte[] b : target) {
    ...
    public static void dumpPacketList(Iterable<TsPacket> target) {
