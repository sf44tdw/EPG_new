...
public final class EventInformationTableBody extends SectionBody {
    ...
    private static final MessageFormat TABLE_DESC = new MessageFormat(
            ...
            + "イベント情報テーブル サービス識別 = {1}\n"
            + "イベント情報テーブル 予約1 = {2}\n"
            + "イベント情報テーブル バージョン番号 = {3}\n"
            + "イベント情報テーブル カレントネクスト指示 = {4}\n"
            + "イベント情報テーブル セクション番号 = {5}\n"
            + "イベント情報テーブル 最終セクション番号 = {6}\n"
            + "イベント情報テーブル トランスポートストリーム識別 = {7}\n"
            + "イベント情報テーブル オリジナルネットワーク識別 = {8}\n"
            + "イベント情報テーブル セグメント最終セクション番号 = {9}\n"
            + "イベント情報テーブル 最終テーブル識別 = {10}\n"
            + "イベント情報テーブル 繰り返し項目のバイト列 = {11}\n"
            + "イベント情報テーブル 繰り返し項目={12}\n"
    );
